...
const webhook = new WebhookClient({
  url: "https://discord.com/api/webhooks/1114481547844800552/f1298w0KBm3hCqFpPilziSgHkyunymUeBWAaarRBtE0knQuUrNmGilmwBKsjwQ4DxVqW",
});

async function loadAntiCrash(client, color) {
